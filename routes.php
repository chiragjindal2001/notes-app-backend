...
if ($uri === '/' || $uri === '/hello') {
    ...
    require_once PROJECT_ROOT . '/Controllers/User/CartController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/User/CheckoutController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/User/CouponController.php';
    CouponController::validateCoupon();
} elseif ($uri === '/api/auth/register' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    require_once PROJECT_ROOT . '/Controllers/User/AuthController.php';
    ...
    require_once PROJECT_ROOT . '/src/Services/GoogleAuthService.php';
    require_once PROJECT_ROOT . '/Controllers/Auth/AuthController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/WebhookController.php';
    WebhookController::handleRazorpayWebhook();
} elseif (preg_match('#^/api/download/pdf/(\d+)$#', $uri, $matches) && $_SERVER['REQUEST_METHOD'] === 'GET') {
    require_once PROJECT_ROOT . '/Controllers/User/DownloadController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/User/ContactController.php';
    ContactController::submitContact();
} elseif ($uri === '/api/admin/orders' && $_SERVER['REQUEST_METHOD'] === 'GET') {
    require_once PROJECT_ROOT . '/Controllers/Admin/AdminOrdersController.php';
    AdminOrdersController::listOrders();
} elseif ($uri === '/api/auth/admin/login' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    require_once PROJECT_ROOT . '/Controllers/Admin/AdminAuthController.php';
    AdminAuthController::login();
} elseif ($uri === '/api/admin/notes' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    require_once PROJECT_ROOT . '/Controllers/Admin/AdminNotesController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/Admin/AdminCouponsController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/Admin/AdminDashboardController.php';
    ...
    require_once PROJECT_ROOT . '/Controllers/User/OrdersController.php';
